...
class FunkinLua {
	...
	public function new(script:String) {
		...
		Lua_helper.add_callback(lua, "openURL", function(theurl:String) {
			FlxG.openURL(theurl);
		});

		Lua_helper.add_callback(lua, "windowAlertMessage", function(message:String, windowTitle:String) {
			Lib.application.window.alert(message, windowTitle);
		});
